...
```bash
python -m pip install git+https://github.com/NexusOrchestrator/nexus_sdk.git@v0.4.19
```
...
```text
nexus-sdk[web,excel,email] @ https://github.com/NexusOrchestrator/nexus_sdk/archive/refs/tags/v0.4.19.zip
```
